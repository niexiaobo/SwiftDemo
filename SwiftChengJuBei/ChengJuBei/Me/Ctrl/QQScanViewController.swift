...
//        navigationController?.pushViewController(vc, animated: true)
    ...
    func drawBottomItems()
    {
        ...
        bottomItemsView = UIView(frame:CGRectMake( 0.0, yMax-100,self.view.frame.size.width, 100+64 ) )
        
        
        bottomItemsView!.backgroundColor = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1)
